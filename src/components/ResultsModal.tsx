...
import { X, AlertTriangle, ChevronDown, TrendingUp, TrendingDown, Minus } from 'lucide-react';
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center md:pl-60 bg-black/50 backdrop-blur-md animate-fade-in" style={{ overscrollBehavior: 'contain' }} onClick={onClose}>
      ...
      >
        ...
        <div className="flex-1 overflow-y-auto scrollbar-thin p-6 space-y-5" style={{ overscrollBehavior: 'contain' }}>
          {!result && <EmptyState />}
...
function EmptyState() {
  return (
    <div className="flex flex-col items-center justify-center py-16 text-text-muted">
      ...
      <p className="text-sm">Clique em "Calcular" para ver o resultado</p>
