...
import { tennisModel } from './sgp/tennis';
import { basketballModel } from './sgp/basketball';
import type { SportInputs, Leg } from './sgp/types';
import { DEFAULT_N_SIM } from './sgp/monte-carlo';
...
export function calcProps(get: (id: string) => string, cfg: Config): BetResult | { err: string } {
...
export function calcProxy(get: (id: string) => string, cfg: Config): BetResult | { err: string } {
...
export function calcAub(get: (id: string) => string, cfg: Config): BetResult | { err: string } {
...
export function calcCombo(get: (id: string) => string, cfg: Config): BetResult | { err: string } {
...
export function calcPoi(get: (id: string) => string, cfg: Config): BetResult | { err: string } {
...
export function calcAsia(get: (id: string) => string, cfg: Config): BetResult | { err: string } {
